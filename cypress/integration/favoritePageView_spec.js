describe ('Favorites Page View', () => {
    ...
    it("Should be able to view favorites after adding image to favorites", () => {
        ...
        cy.get('button').contains('Add to Favorites').click()
        cy.get('a').contains('My Favs').click()
        cy.get('section').should('have.class', 'favorites-container').get('img').should('have.attr', 'src', 'https://lh5.ggpht.com/JH0svNh0Pkov_W97MDHw8v2-qKS8AdixVJ-CiPL_xBECNdEyTBkicMvZBsqgW6GQ0TB9moKnfGUYacWQS32rqeoEjA4=s0')
      });
